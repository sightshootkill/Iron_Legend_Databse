...
import com.example.userdaniel.ironkingdoms.dummy.DummyContent;
...
public class OtherFragment extends ListFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setListAdapter(new ArrayAdapter<String>(getActivity(),
                R.layout.ironkingdoms_list_item_1, getResources().getStringArray(R.array.other_items)));
    }
    ...
    private void displayView(int position) {
        ...
        if (fragment != null) {
            ...
            fragmentManager.beginTransaction()
                    .addToBackStack(null).setCustomAnimations(R.anim.enter_from_right, R.anim.exit_to_left, R.anim.enter_from_left, R.anim.exit_to_right).replace(R.id.main_content, fragment).commit();
